...
%function_characteristcs_plot - plot characteristics
...
%eta_cell - viscosity coefficient 
% xticks_vec - x axis ticks
% yticks_vec - y axis ticks
% plot_every_n_characteristics - how many characteristics to plot e.g. when 1 plots every spring boundary trajectory
% circle_size - size of circles on characteristics plot

% Calculate total number of springs
total_springs = N_cells*m_springs_per_cell;

% Set the default axes font size for figures
