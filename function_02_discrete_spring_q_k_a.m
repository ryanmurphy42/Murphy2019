...
reltol=1.0e-10; %relative tolerance for ode15s
abstol=1.0e-10; %absolute tolerance for ode15s
odeeeoptions=odeset('RelTol',reltol,'AbsTol',abstol,'Events',@function_04_eventfun); %options for ode15s - stop when velocity is 1e-10
...
for m_springs_per_cell=[1,2,4]
    ...
    %% Convert initial cell stiffness and resting cell length into spring properties
